function revslider_showDoubleJqueryError(e) {
    ...
    function r(r, i) {
        ...
        if (!r.hasClass("revslider-initialised")) {
            ...
            e(window).on("mozfullscreenchange webkitfullscreenchange fullscreenchange",
            function() {
            ...
            r.find(".tp-scrollbelowslider").on("click",
            function() {
                var t = 0;
                try {
    ...
    var y = function(n, r) {
        ...
        n.find(">ul:first >li >img").each(function(n) {
            ...
            i.replaceWith('<div class="tp-bgimg defaultimg" data-lazyload="' + i.data("lazyload") + '" data-bgfit="' + u + '"data-bgposition="' + l + '" data-bgrepeat="' + f + '" data-lazydone="' + i.data("lazydone") + '" src="' + s + '" data-src="' + s + '" style="background-color:' + i.css("backgroundColor") + ";background-repeat:" + f + ";background-image:url(" + s + ");background-size:100% 100%;background-position:" + l + ';width:100%;height:100%;"></div>');
            if (a(8)) {
                c.find(".tp-bgimg").css({
    ...
    var $ = function(n, r) {
        ...
        if (r.slideamount > 1 && !(r.stopAfterLoops == 0 && r.stopAtSlide == 1)) {
            ...
            n.on("starttimer",
            function() {
                if (r.conthover != 1 && r.videoplaying != true && r.width > r.hideSliderAtLimit && r.bannertimeronpause != true && r.overnav != true) if (r.stopLoop == "on" && r.next == r.lastslidetoshow - 1 || r.noloopanymore == 1) r.noloopanymore = 1;
                else {
                    i.css({
                        visibility: "visible"
                    });
